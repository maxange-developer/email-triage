      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        ...
        <div className="glass border border-neon-green/30 w-full max-w-md p-8 animate-fade-up space-y-6">
          ...
          <div className="text-center space-y-2">
            <h1 className="text-2xl font-bold text-neon-green whitespace-nowrap">
              {t.login.title}<span className="text-white">.</span>
            </h1>
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-white/30 leading-relaxed">{t.login.security_desc}</p>
          </div>
          ...
          {USE_MOCK && (
            <div className="border-t border-white/10 pt-4">
              ...
              <p className="text-white/20 text-xs text-center mt-2">{t.login.demo_note}</p>
            </div>
          )}
