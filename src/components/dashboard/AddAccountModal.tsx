      ...
      <div className="glass border border-neon-blue/30 w-full max-w-md animate-fade-up">
        ...
        <div className="p-6 space-y-6">
          <div className="glass border border-white/10 p-4 flex items-start gap-3">
            <Shield size={16} className="text-neon-blue shrink-0 mt-0.5" />
            <div>
          ...
          <button
            ...
            className="w-full py-3 border-2 border-neon-blue text-white text-sm font-semibold uppercase tracking-wider relative overflow-hidden hover:text-black transition-all duration-300 group flex items-center justify-center gap-3"
          >
