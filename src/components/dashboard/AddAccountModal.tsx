      ...
      <div className="glass border border-neon-green/30 w-full max-w-md animate-fade-up">
        <div className="flex items-center justify-between p-6 border-b border-white/10">
          <h2 className="font-bold text-white text-lg">
            {t.modal.title}<span className="text-white">.</span>
          </h2>
          <button
        ...
        <div className="p-6 space-y-6">
          <div className="glass border border-white/10 p-4 flex items-start gap-3">
            ...
            <div>
              <p className="text-white text-sm font-medium mb-1">{t.modal.oauthTitle}</p>
          ...
          <div className="space-y-2">
            <p className="text-white/40 text-xs uppercase tracking-widest">{t.modal.permissionsLabel}</p>
          ...
          <button
            ...
            className="w-full py-3 border-2 border-neon-green text-white text-sm font-semibold uppercase tracking-wider relative overflow-hidden hover:text-white transition-all duration-300 group flex items-center justify-center gap-3"
          >
            <Mail size={16} className="relative z-10" />
            <span className="relative z-10">{t.modal.cta}</span>
